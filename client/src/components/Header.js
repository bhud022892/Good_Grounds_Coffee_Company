                            ...
                            {userInfo ? (                                
                                ...
                                >
                                    <LinkContainer to='/profile'>
                                        <NavDropdown.Item className='nav-dropdown-link'>Profile</NavDropdown.Item>
                                    </LinkContainer>
                                    <NavDropdown.Item className='nav-dropdown-link' onClick={logoutHandler}>Logout</NavDropdown.Item>
                                </NavDropdown>
